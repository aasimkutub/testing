...
import com.tthings.remote_application.Adapter.ExtraButtonAdapter;
import com.tthings.remote_application.Adapter.NumPadAdapter;
import com.tthings.remote_application.R;

public class ExtraButton extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ExtraButtonAdapter adapter = new ExtraButtonAdapter(getActivity());
        gv.setNumColumns(3);
